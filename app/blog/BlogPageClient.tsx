...
import { ArrowRight, Clock, Video, Youtube, Headphones, Users } from "lucide-react";
                                ...
                                {featured && (
                                    <Link href={`/blog/${featured.slug}`} className="group cursor-pointer">
                                        <div className="relative rounded-xl overflow-hidden mb-4 bg-[#222] border border-white/5">
                                            <div className="w-full h-64 md:h-80 bg-[#333] flex items-center justify-center text-[#666] relative">
                                                <div className="absolute inset-0 bg-[#222] flex items-center justify-center text-[#444]">
                                                    [Featured: {featured.title.substring(0, 20)}...]
                                                </div>
                                            </div>
                                            {featured.readTime && (

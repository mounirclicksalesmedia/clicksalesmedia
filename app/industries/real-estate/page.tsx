                ...
                <div className="grid lg:grid-cols-2 gap-12 items-start">
                    <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}>
                        ...
                        <BookingButton
                            ...
                            source="industry-real-estate-hero"
                        />
                    </motion.div>
...
function CTASection() {
    return (<section className="py-20 bg-[#272727]"><div className="container mx-auto px-6"><div className="glass-card p-12 text-center bg-gradient-to-br from-[#AD8253]/10 to-transparent border-[#AD8253]/20"><motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}><h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Ready to Dominate Your Real Estate Market?</h2><p className="text-[#a1a1a1] mb-8 max-w-2xl mx-auto">Let's discuss how we can help you attract more qualified buyers and sellers.</p>
        <BookingButton
            text="Schedule a Consultation"
            variant="primary"
            className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-[#AD8253] to-[#c3a177] text-[#1a1a1a] font-semibold rounded-full hover:shadow-[0_0_40px_rgba(173,130,83,0.4)] transition-all"
            source="industry-real-estate-cta"
        />

        ...
        <>
            <motion.header
                ...
                className={cn(
                    ...
                    scrolled
                        ? "bg-[#272727]/80 backdrop-blur-xl border-b border-[#AD8253]/10"
                        : "bg-transparent"
                )}
            >
                    ...
                    <ul className="hidden lg:flex items-center gap-8">
                        {navItems.map((item) => (
                            ...
                            >
                                <Link
                                    href={item.href}
                                    className="text-[#a1a1a1] hover:text-white transition-colors duration-300 text-sm font-medium relative group flex items-center gap-1"
                                >
                                    {item.name}
                                    {item.hasDropdown && (
                                        <svg
                                    ...
                                    <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-[#AD8253] to-[#c3a177] group-hover:w-full transition-all duration-300" />
                                </Link>
            ...
            <AnimatePresence>
                {mobileMenuOpen && (
                    <motion.div
                        ...
                        exit={{ opacity: 0 }}
                        transition={{ duration: 0.2 }}
                        className="fixed inset-0 z-40 bg-[#1a1a1a]/98 backdrop-blur-xl lg:hidden overflow-y-auto"
                    >
                        <nav className="container mx-auto px-6 pt-28 pb-8">
